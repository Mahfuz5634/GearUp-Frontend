  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="font-display text-2xl text-ink tracking-tight">User Management</h2>
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-line rounded-lg focus:ring-2 focus:ring-trail outline-none text-sm bg-card"
            value={searchTerm}
            onChange={(e) => {
                    ...
                    {Array.from({ length: totalPages }).map((_, i) => (
                      <button
                        ...
                        className={`w-8 h-8 flex items-center justify-center rounded-md text-sm font-medium transition-colors ${
                          currentPage === i + 1 ? 'bg-trail text-white' : 'text-ink-soft hover:bg-line/50 hover:text-ink'
                        }`}
                      >
                        {i + 1}
                      </button>
